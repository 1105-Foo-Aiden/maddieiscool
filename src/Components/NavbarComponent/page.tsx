...
export default function NavbarComponent() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#AEE6D9] to-[#3EBE9F] min-h-28 flex justify-between">
      ...
      <Dropdown label=" " renderTrigger={() => <span className="mt-5 mr-5 w-20 h-20 border-solid border-2 border-black bg-blue-700 rounded-full"></span>} className="flex justify-center w-fit border-solid border-2 rounded-md border-black">
